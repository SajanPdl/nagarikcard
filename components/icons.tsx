...
export const GovFlowLogoIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={`${className} high-contrast-ignore`} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <pattern id="dhaka" patternUnits="userSpaceOnUse" width="10" height="10">
        <rect width="10" height="10" fill="#C8102E"/>
        <path d="M-1,1 l2,-2 M0,10 l10,-10 M9,11 l2,-2" stroke="#A40D26" strokeWidth="1"/>
        <path d="M-1,6 l6,-6 M-1,8 l8,-8 M-1,10 l10,-10" stroke="#A40D26" strokeWidth="1"/>
      </pattern>
       <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stopColor="#E02041" />
        <stop offset="100%" stopColor="#C8102E" />
      </linearGradient>
    </defs>
    <g transform="skewX(-10)">
      <polygon points="0,0 42,0 22,100 0,100" fill="url(#logoGradient)" />
      <polygon points="5,5 39,5 21,95 5,95" fill="url(#dhaka)" />
      
      <polygon points="58,0 100,0 80,100 38,100" fill="url(#logoGradient)" />
      <polygon points="61,5 95,5 77,95 43,95" fill="url(#dhaka)" />
    </g>
    
    <g fill="white">
      {/* Moon */}
      <path d="M78,25 a1,1 0 0 1 0,10 a1,1 0 0 1 0,-10 M78,26 a1,1 0 0 0 0,8 a1,1 0 0 0 0,-8" transform="scale(0.8) translate(5, 5)" />
      {/* Sun */}
      <path d="M78,45 l2,2 l3-1 l2,2 l-1,3 l2,2 l-3,1 l-2,2 l-1-3 l-2,2 l1-3 l-2-2 l3,-1 l2,-2 l-3,1 Z" transform="scale(0.8) translate(5, 5)"/>
    </g>
  </svg>
);

export const NepalFlagIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 810 990">
    <path fill="#C51E3A" d="M0 0h810L270 330v660H0z"/>
    <path fill="#C51E3A" d="M0 360h810L270 690v300H0z"/>
    <path fill="#003893" d="M0 0v990h240V330z"/>
    <circle cx="135" cy="540" r="101.25" fill="#fff"/>
    <path fill="#003893" d="M135 465.75c-41.42 0-75 33.58-75 75s33.58 75 75 75c20.71 0 39.54-8.4 53.03-21.97-13.49-13.57-21.97-32.4-21.97-53.03s8.48-39.46 21.97-53.03C174.54 474.15 155.71 465.75 135 465.75z"/>
    <path fill="#fff" d="M135 225l18.75 42.1875L202.5 270l-33.75 22.5 11.25 45L135 303.75 90 337.5l11.25-45L67.5 270l48.75-2.8125z"/>
  </svg>
);
...
export const WalletIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M19 7V4a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3"/><path d="M3 5h18"/><path d="M18 12.5a2.5 2.5 0 0 1 0 5h-4a2.5 2.5 0 0 1 0-5h4Z"/></svg>
);

export const ShieldLockIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/><path d="M12 11v4"/><path d="M12 8a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5z"/></svg>
);
...
export const SathiAiIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const IdCardIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M6 10h2"/><path d="M10 10h4"/><path d="M6 14h8"/></svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m12 3-1.9 5.8-5.8 1.9 5.8 1.9 1.9 5.8 1.9-5.8 5.8-1.9-5.8-1.9zM3 12l1.9-5.8L10.7 8l-5.8-1.9zM13.3 16l5.8-1.9-1.9-5.8-5.8 1.9z"/></svg>
);
...
export const HealthIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M9 12h6"/></svg>
);
...
export const CarIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10h-3.26a3 3 0 0 0-1.8 3.22c.2.8.7 1.4 1.4 1.7.9.3 2 .3 2.9.2H12l-2-3-4-3-1 2-2 7h3c.6 0 1-.4 1-1v-2h12v2c0 .6.4 1 1h2z"/><path d="M7 17a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/><path d="M17 17a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/></svg>
);
...
export const KioskAvatarIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 8V6M8 12H6M16 12h2M12 16v2"/>
        <circle cx="12" cy="12" r="10"/>
        <path d="M8.5 9.5c.5 1 1.5 2 3.5 2s3-1 3.5-2"/>
        <path d="M8.5 14.5c.5-1 1.5-2 3.5-2s3 1 3.5 2"/>
    </svg>
);

export const FingerprintIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 12a3 3 0 0 0-3 3"/><path d="M12 12h.01"/><path d="M15 12a3 3 0 0 1 3 3"/><path d="M9 12a3 3 0 0 0-3 3"/><path d="M12 15a3 3 0 0 0 3-3"/><path d="M6.383 12.126A4.982 4.982 0 0 1 7 10a5 5 0 0 1 10 0 4.982 4.982 0 0 1 .617 2.126"/><path d="M12 12a3 3 0 0 1 3 3"/><path d="M12 3v1a2 2 0 0 1-2 2H8a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2h-1a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h1a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-4a2 2 0 0 1-2-2V3"/></svg>
);
...
export const AccessibilityIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="10"></circle><path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"></path><path d="M12 12v6"></path><path d="m9 12 6 6"></path></svg>
);
