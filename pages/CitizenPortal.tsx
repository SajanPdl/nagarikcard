...
}> = ({ profile, applications, services, offices, notifications, onNavigate, onQuickApply }) => {
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-8">
                     <div className="bg-gradient-to-br from-[#003893] to-blue-800 text-white rounded-2xl p-6 shadow-xl text-center cursor-pointer hover:shadow-2xl transition-shadow" onClick={() => dispatch({type: 'TOGGLE_AI_MODAL'})}>
...
export const CitizenPortal: React.FC = () => {
  ...
  const { profile, wallet, applications, services, toasts, citizenPage, selectedServiceId } = state;
  ...
  const renderPage = () => {
    ...
    switch (citizenPage) {
      ...
      case 'application':
        return selectedService ? <ApplicationPage service={selectedService} profile={profile} wallet={wallet} onSubmit={handleApplicationSubmit} /> : <p>Service not selected. Please go back to the service catalog.</p>;
